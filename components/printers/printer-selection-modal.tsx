...
import { X, Search, Plus, Cpu, Layers, Ruler, ArrowLeft } from "lucide-react"
...
export function PrinterSelectionModal({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-4xl bg-zinc-950 border border-white/10 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-200">
                {!selectedPrinter ? (
                    <>
                        {/* Header */}
                        <div className="p-6 border-b border-white/5 flex items-center justify-between bg-gradient-to-r from-white/5 to-transparent">
                            <div>
                                ...
                                <p className="text-xs text-zinc-500 font-mono mt-1">Select a printer from the global registry to add to your dashboard.</p>
                            </div>
                            ...
                            {loading ? (
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                    {filteredPrinters.map((printer) => (
                                        ...
                                        >
                                            {/* Image Section */}
                                            <div className="relative h-40 bg-zinc-800/50 flex items-center justify-center overflow-hidden">
                                                {printer.imageUrl ? (
                                                    <Image
                                                ...
                                                {/* Add Button Overlay */}
                                                <div className="absolute top-2 right-2 bg-zinc-900/90 backdrop-blur-sm rounded-lg p-2 group-hover:bg-neon-cyan/20 transition-colors border border-white/10">
                                                    <Plus className="size-4 text-zinc-400 group-hover:text-neon-cyan transition-colors" />
                                                </div>
                                            </div>
                                            ...
                                            <div className="p-4 space-y-3">
                                                ...
                                                <div className="space-y-1.5 pt-2 border-t border-white/5">
                                                    ...
                                                    {printer.priceUsd && (
                                                        <div className="text-[11px] text-neon-cyan font-bold font-mono pt-1">
                    ...
                    <>
                        ...
                        <div className="p-6 border-b border-white/5 flex items-center justify-between bg-gradient-to-r from-white/5 to-transparent">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h2 className="text-2xl font-bold font-rajdhani uppercase tracking-tight text-white">Configure Printer</h2>
                                    <p className="text-xs text-zinc-500 font-mono mt-1">Set a custom name and IP address for this printer.</p>
                                </div>
                            </div>
                            <button onClick={onClose} className="p-2 hover:bg-white/5 rounded-full text-zinc-500 hover:text-white transition-colors">
                                <X className="size-5" />
                        ...
                        <div className="flex-1 overflow-auto p-6 custom-scrollbar">
                            <div className="max-w-2xl mx-auto space-y-6">
                                ...
                                <div className="bg-zinc-900/40 border border-white/5 rounded-xl p-4 flex items-center gap-4">
                                    <div className="w-20 h-20 bg-zinc-800/50 rounded-lg flex items-center justify-center flex-shrink-0">
