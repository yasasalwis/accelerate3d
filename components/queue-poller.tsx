...
export function QueuePoller() {
    ...
    return (
        <div
            className="fixed bottom-4 right-4 bg-black/80 text-xs p-2 rounded border border-white/10 backdrop-blur text-muted-foreground z-50 group">
            ...
            {(error || lastRun) && (
                <div
                    className="absolute bottom-full right-0 mb-2 w-64 p-2 bg-zinc-900 border border-white/10 rounded shadow-xl text-[10px] hidden group-hover:block">
                    {error ? (
