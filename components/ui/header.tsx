...
export function Header() {
    ...
    return (
        <header className="h-14 border-b border-white/5 flex items-center justify-between px-6 bg-background/50 backdrop-blur-md sticky top-0 z-10">
            {/* Breadcrumbs */}
                ...
                <Popover>
                    <PopoverTrigger asChild>
                        <button className="relative p-2 text-zinc-500 hover:text-zinc-200 transition-colors">
                            ...
                            {unreadCount > 0 && (
                                <span className="absolute top-1.5 right-1.5 size-2 bg-red-600 rounded-full border border-background shadow-[0_0_8px_rgba(220,38,38,0.5)]"></span>
                            )}
                        </button>
                    </PopoverTrigger>
