...
INSERT INTO "new_Printer" ("apiKey", "createdAt", "currentJobId", "id", "ipAddress", "isAutoEjectCapable", "name", "status", "type", "updatedAt") SELECT "apiKey", "createdAt", "currentJobId", "id", "ipAddress", "isAutoEjectCapable", "name", "status", "type", "updatedAt" FROM "Printer";
DROP TABLE "Printer";
