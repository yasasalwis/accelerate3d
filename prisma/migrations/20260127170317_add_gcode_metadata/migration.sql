...
-- AlterTable
ALTER TABLE "Model"
    ADD COLUMN "bedTempC" INTEGER;
ALTER TABLE "Model"
    ADD COLUMN "layerHeightMm" REAL;
ALTER TABLE "Model"
    ADD COLUMN "material" TEXT;
ALTER TABLE "Model"
    ADD COLUMN "nozzleTempC" INTEGER;
...
INSERT INTO "new_PrintJob" ("autoEjectTriggered", "createdAt", "endTime", "id", "modelId", "startTime", "status",
                            "userPrinterId")
SELECT "autoEjectTriggered",
       "createdAt",
       "endTime",
       "id",
       "modelId",
...
INSERT INTO "new_UserPrinter" ("apiKey", "createdAt", "currentJobId", "id", "ipAddress", "isAutoEjectCapable", "name",
                               "printerId", "status", "type", "updatedAt", "userId")
SELECT "apiKey",
       "createdAt",
       "currentJobId",
       "id",
